...
- 可解释/鲁棒的机器学习算法设计（**超参自动优化**、稀疏**可加建模**、**LLM幻觉检测**）
...
- 期刊审稿人: [Expert Systems With Applications](https://www.sciencedirect.com/journal/expert-systems-with-applications), [Molecular & Cellular Biomechanics](https://www.techscience.com/journal/mcb), [Journal of Infrastructure, Policy and Development](https://systems.enpress-publisher.com/index.php/jipd), [International Journal of Applied and Computational Mathematics](https://link.springer.com/journal/40819).
